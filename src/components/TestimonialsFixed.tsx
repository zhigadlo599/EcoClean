...
const testimonials = [
  ...
  },
  {
    ...
    content:
      'Ефективні екологічні рішення та дуже компетентний персонал. Наш ресторан ніколи не був таким чистим!',
    rating: 5,
    image:
  ...
  },
  {
    ...
    content:
      'Надійний партнер для прибирання нашої клініки. Ідеальна гігієна та дотримання протоколів.',
    rating: 5,
    image:
